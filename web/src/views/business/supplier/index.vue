...
import { supplierApi, type SupplierDTO } from '@/api/business'

interface Row extends SupplierDTO {
  createTime?: string
}
...
async function loadData() {
  loading.value = true
  try {
    const res: any = await supplierApi.page(query)
    ...
    <div class="card search-bar">
      <el-form inline>
        <el-form-item label="名称">
          <el-input v-model="query.name" placeholder="供应商名称" clearable style="width: 180px" @keyup.enter="handleSearch" />
        </el-form-item>
        <el-form-item label="编号">
          <el-input v-model="query.code" placeholder="供应商编号" clearable style="width: 180px" @keyup.enter="handleSearch" />
        </el-form-item>
        <el-form-item>
        ...
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="供应商编号" prop="code">
              <el-input v-model="form.code" placeholder="如 S001" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="供应商名称" prop="name">
              <el-input v-model="form.name" placeholder="供应商/公司名称" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
